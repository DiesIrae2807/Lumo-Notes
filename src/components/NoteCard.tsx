  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <span className={`mt-0.5 h-4 w-4 rounded ${accentMap[note.accent]} grid place-items-center text-[10px] font-bold`}>
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-1 line-clamp-1 text-xs leading-5 text-slate-400">{note.preview}</p>
