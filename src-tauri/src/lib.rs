...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            db::get_tags,
            db::get_attachments,
            db::get_attachment_backup_payloads,
            db::restore_backup_attachments,
            ...
            db::lock_note,
            db::unlock_note,
            db::encrypt_note_attachments,
            db::change_lock_password,
            db::search_notes,
            db::rebuild_search_index,
            db::attach_file_to_note,
            db::remove_attachment,
            db::open_attachment,
            db::open_external_url,
            db::save_attachment_as,
            db::get_attachment_data_url,
            db::get_app_settings,
            db::set_app_setting,
            db::get_or_create_device_identity,
            db::create_sync_conflict,
            db::list_sync_conflicts,
            db::resolve_sync_conflict,
            db::mark_sync_conflict_resolution_synced,
            db::create_cloud_backup_password_metadata,
            db::verify_cloud_backup_password,
            db::encrypt_cloud_backup,
            db::decrypt_cloud_backup,
            db::google_oauth_authorize,
            db::create_folder,
            db::update_folder,
            db::delete_folder,
            db::set_note_folder,
